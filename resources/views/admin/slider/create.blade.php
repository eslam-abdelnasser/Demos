        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Add Slider </div>
                    <div class="tools">
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label>{{$language->name}} First Title</label>
                                                    <div class="input-group">
                                                        <span class="input-group-addon input-circle-left">
                                                            <i class="fa fa-align-justify"></i>
                                                        </span>
                                                        <input type="text" name="title_first_{{$language->label}}" value="{{old('title_first_'.$language->label)}}" id="title_first_{{$language->label}}" class="form-control input-circle-right" placeholder="First title"> </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>{{$language->name}} Second title</label>
                                                    <div class="input-group">
                                                        <span class="input-group-addon input-circle-left">
                                                            <i class="fa fa-align-justify"></i>
                                                        </span>
                                                        <input type="text" name="title_second_{{$language->label}}" value="{{old('title_second_'.$language->label)}}" id="title_second_{{$language->label}}" class="form-control input-circle-right" placeholder="Secnd title"> </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>{{$language->name}} small Description</label>
                                                    <div class="input-group">
