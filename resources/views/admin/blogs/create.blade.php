                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="auther_name_{{$language->label}}" id="auther_name_{{$language->label}}" class="form-control input-circle-right" placeholder="Auther Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="title_{{$language->label}}" id="title_{{$language->label}}" class="form-control input-circle-right" placeholder="Blog Title">
                                                    </div>
                                                </div>
                                                <div class="form-group">
